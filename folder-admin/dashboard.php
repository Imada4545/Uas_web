...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-info fixed-top">
    <div class="container-fluid">
      <a class="navbar-brand text-white" href="#"> Admin <i class="fas fa-user-circle mr-5"></i> | <b>PT.
          INDONESIA</b></a>
      <form class="d-flex">
      ...
      <div class="row mt-2">
        <div class="card shadow text-white text-center" style="width: 22rem;">
          ...
          <div class="card-body">
            ...
            <a href="https://www.instagram.com/invites/contact/?i=18mgivlb4h0hp&utm_content=12l1zgj">
        ...
        <div class="card shadow mx-2 text-white text-center" style="width: 22rem;">
          ...
          <div class="card-body">
            ...
            <a href="https://www.facebook.com/irere.nene">
